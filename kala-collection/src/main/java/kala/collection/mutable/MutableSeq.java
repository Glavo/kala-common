...
public interface MutableSeq<E> extends MutableCollection<E>, Seq<E>, MutableAnySeq<E> {
    ...
    default @NotNull MutableSeq<E> onEach(@NotNull Consumer<? super E> action) {
        forEach(action);
        return this;
    }
    ...
    @Contract(value = "_ -> this", pure = true)
    default <Ex extends Throwable> @NotNull MutableSeq<E> onEachChecked(@NotNull CheckedConsumer<? super E, ? extends Ex> action) throws Ex {
    ...
    @Contract(value = "_ -> this", pure = true)
    default @NotNull MutableSeq<E> onEachUnchecked(@NotNull CheckedConsumer<? super E, ?> action) {
        return onEach(action);
    }
    ...
    @Contract(value = "_ -> this", pure = true)
    default @NotNull MutableSeq<E> onEachIndexed(@NotNull IndexedConsumer<? super E> action) {
    ...
    @Contract(value = "_ -> this", pure = true)
    default <Ex extends Throwable> @NotNull MutableSeq<E> onEachChecked(@NotNull CheckedIndexedConsumer<? super E, ? extends Ex> action) throws Ex {
    ...
    @DelegateBy("onEachIndexed(IndexedConsumer<E, Ex>)")
    @Contract(value = "_ -> this", pure = true)
    default @NotNull MutableSeq<E> onEachUnchecked(@NotNull CheckedIndexedConsumer<? super E, ?> action) {
        return onEachIndexed(action);
    }
}
