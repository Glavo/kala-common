...
public interface SeqLike<E> extends CollectionLike<E>, AnySeqLike<E>, OrderedTraversable<E> {
    ...
    default @NotNull SeqLike<E> onEach(@NotNull Consumer<? super E> action) {
        forEach(action);
        return this;
    }
    ...
    @Contract(value = "_ -> this", pure = true)
    default <Ex extends Throwable> @NotNull SeqLike<E> onEachChecked(@NotNull CheckedConsumer<? super E, ? extends Ex> action) throws Ex {
    ...
    @Contract(value = "_ -> this", pure = true)
    default @NotNull SeqLike<E> onEachUnchecked(@NotNull CheckedConsumer<? super E, ?> action) {
        return onEach(action);
    }
    ...
    @Contract(value = "_ -> this", pure = true)
    default @NotNull SeqLike<E> onEachIndexed(@NotNull IndexedConsumer<? super E> action) {
    ...
    @Contract(value = "_ -> this", pure = true)
    default <Ex extends Throwable> @NotNull SeqLike<E> onEachChecked(@NotNull CheckedIndexedConsumer<? super E, ? extends Ex> action) throws Ex {
    ...
    @DelegateBy("onEachIndexed(IndexedConsumer<E, Ex>)")
    @Contract(value = "_ -> this", pure = true)
    default @NotNull SeqLike<E> onEachUnchecked(@NotNull CheckedIndexedConsumer<? super E, ?> action) {
        return onEachIndexed(action);
    }
}
