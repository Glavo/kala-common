...
public final class KVTree<K, V> implements Map.Entry<K, V>, Serializable {
    ...
    /**
     * Constructor for a non-empty/non-leaf node. Only intended to be called via {@code join()},
    ...
    public static <K, V> KVTree<K, V> fromEntryIterator(
    ...
    public static <K, V> KVTree<K, V> fromKeyIterator(final Iterator<? extends K> iterator) {
     ...
     */
    public Iterator<Map.Entry<K, V>> entryIterator(final boolean isLeftToRight) {
    ...
    public KVTree<K, V> minus(final K key, final Comparator<? super K> comparator) {
        if (this.isEmpty()) {
            return this;
        }
    ...
    public KVTree<K, V> plus(final K key, final V value, final Comparator<? super K> comparator) {
        if (this.isEmpty()) {
    ...
    public KVTree<K, V> rangeToRight(
            final K leftBound,
            final boolean isleftBoundInclusive,
            final Comparator<? super K> comparator) {
        if (this.isEmpty()) {
