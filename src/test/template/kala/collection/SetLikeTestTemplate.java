...
public interface SetLikeTestTemplate extends CollectionLikeTestTemplate {
    ...
    default void filterTest() {
        ...
        assertSetElements(List.of(), of(1).filter(Predicates.alwaysFalse()));
        assertSetElements(List.of(1), of(1).filter(Predicates.alwaysTrue()));
        ...
        assertSetElements(List.of(4, 5), of(1, 2, 3, 4, 5).filter(it -> it > 3));
    }
