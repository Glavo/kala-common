...
public final class ImmutableTreeSeqTest implements ImmutableSeqTestTemplate {
    @Override
    public <E> CollectionFactory<E, ?, ImmutableTreeSeq<E>> factory() {
        return ImmutableTreeSeq.factory();
    }
